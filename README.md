...
The "Overcommit" process is broken down into for sections of logs. On the far right of each line, you can see how long each section took. Reviewing that image above shows that most of the work happened in a section simply titled "false". Clicking on that line of text will reveal even more info.
